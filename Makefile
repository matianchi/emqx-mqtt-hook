...
app.config: $(CUTTLEFISH_SCRIPT) etc/emqx_mqtt_hook.conf
	$(verbose) $(CUTTLEFISH_SCRIPT) -l info -e etc/ -c etc/emqx_mqtt_hook.conf -i priv/emqx_mqtt_hook.schema -d data
